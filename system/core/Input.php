...
class CI_Input {
	...
	*/
	...
	{
		return (php_sapi_name() == 'cli' || defined('STDIN') || defined('STDOUT') || isset($_SERVER['SHELL'])); // supports 1and1 shared hosting package
		// default: return (php_sapi_name() === 'cli' OR defined('STDIN'));
	}
