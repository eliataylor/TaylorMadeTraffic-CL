...
abstract class BaseFacebook
{
  ...
  public static $CURL_OPTS = array(
    ...
    CURLOPT_SSLVERSION => 3 // http://stackoverflow.com/questions/7511802/fatal-error-uncaught-curlexception-ssl-connection-timeout-in-facebook-api-3-0-0
  );
  ...
  protected function _graph($path, $method = 'GET', $params = array()) {
    ...
    if (is_array($result) && isset($result['error'])) {
        echo "FACEBOOK ERRORS ARE NOT SUFFICIENT FOR: " . $path;
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if ($errno == 60 || $errno == 77) {
      ...
      $crt = dirname(__FILE__) . DIRECTORY_SEPARATOR . 'fb_ca_chain_bundle.crt';
      if (!is_file($crt)) log_message("error", "invalid: ". $crt);
